...
<body>
    ...
    <div class="container-fluid py-3">
        <div class="row">
            ...
            <!-- Body -->
            <?php
            $baru = $conn->query("SELECT IdTransaksi FROM transaksi ORDER BY IdTransaksi DESC");
            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="transaksi_create.php" method="post" id="transaksi" enctype="multipart/form-data">
